...
```{r, fig.width=10, fig.height=10, out.width="50%", fig.align='center'}
library(ggtext)
...
## To-Do
  ...
  -   Validation
  -   Ranges of runs with KGE > 0.6 and improvement in NSE
  -   new simulations in this range?
  -   adding the filtered piezometers as group 2 to see comparison